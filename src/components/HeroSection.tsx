        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            >
                ...
                <img
                    ...
                    className="relative w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-primary-500/30 shadow-xl shadow-primary-500/20"
                />
            </motion.div>
            ...
            <div className="flex-1 text-center md:text-left">
                ...
                >
                    <a
                        ...
                        className="flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-medium shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 hover:scale-105 transition-all"
                    >
                    ...
                    <a
                        ...
                        className="flex items-center gap-2 px-5 py-3 rounded-full glass text-gray-300 hover:text-white hover:border-primary-500/50 transition-all hover:scale-105"
                    >
